---
output:
  html_document: ESEM-within-CFA
  pdf_document: ESEM-within-CFA
---
Libraries
```{r}
#packageurl <- "https://cran.r-project.org/src/contrib/Archive/lavaanPlot/lavaanPlot_0.6.0.tar.gz"
...
```{r}
setwd('Z:/IBu/UK_BB/brainbody/cognition/folds/')
```

Upload train and test sets generated and scaled in Python
```{r}
base_path <- 'Z:/IBu/UK_BB/brainbody/cognition/folds/fold_'
...
*1 - Residual variance* = Variance EXPLAINED by the latent factors (R²)
